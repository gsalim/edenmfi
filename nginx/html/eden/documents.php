    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal">
                <?php
                $fields = array("Member ID","Documents","Doc_Sl","Doc_Document Name","Doc_Short Name","Doc_Issue Date","Doc_Expiry Date","Doc_Last Renewal Date","Doc_Issue Authority","Doc_Type of License");
                //var_dump($fields);
