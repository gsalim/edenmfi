    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal">
                <?php
                $fields = array("Member ID","Transaction Profile","TP_Declaration Date","TP_Transaction Type","TP_Description","TP_Voucher Type","TP_No of Transaction Per Month","TP_Maximum Amount per Transaction","TP_Total Amount Per Month","TP_Source of Funds");
                //var_dump($fields);
